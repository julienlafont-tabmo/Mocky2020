...
package object config {
  case class ServerConfig(host: String, port: Int, domain: String)

  case class DatabaseConfig(driver: String, url: String, user: String, password: String, threadPoolSize: Int = 8)
