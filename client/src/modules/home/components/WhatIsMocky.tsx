...
import code from './assets/mocky-code3.png';
        ...
        <div className="row justify-content-around">
          ...
          <div className="col-md-6 col-lg-5">
            <div className="switchable__text">
              ...
              <p className="lead">
                Don't wait for the backend to be ready, generate custom API responses with Mocky and start working on
                your application straightaway
              </p>
              <NavLink to="/create">Start designing your mock »</NavLink>
            </div>
          </div>
        </div>
      </div>
