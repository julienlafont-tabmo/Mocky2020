...
const CallToActionDesignMock = () => (
  <>
    <a id="cta-new-mock" className="in-page-link"></a>
            ...
            <div className="cta cta-1 cta--horizontal boxed boxed--border text-center-xs">
              <div className="row justify-content-center p-5">
                ...
                <div className="col-lg-4 text-center">
                  <NavLink to="/create" className="btn btn--primary type--uppercase">
...
export default CallToActionDesignMock;
