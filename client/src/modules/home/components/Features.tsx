        ...
        <div className="col-md-6 col-lg-3">
          <div className="feature feature-6">
            ...
            <p>
              ...
              <b>forever</b> (just call it one time per year), but without any <NavLink to="/faq">guarantee</NavLink>.
            </p>
          </div>
        </div>
        <div className="col-md-6 col-lg-3">
          <div className="feature feature-6">
            ...
            <p>
              ...
              <br />
              The next release will go further with request inspector and cloud-based mock management.
            </p>
          </div>
        </div>
        <div className="col-md-6 col-lg-3">
