...
mr = (function (mr, $, window, document) {
  ...
  mr.util.getURLParameter = function (name) {
    return (
      decodeURIComponent(
        (new RegExp('[?|&]' + name + '=' + '([^&;]+?)(&|#|;|$)').exec(location.search) || [undefined, ''])[1].replace(
          /\+/g,
          '%20'
        )
      ) || null
  ...
  mr.countdown.documentReady = function ($) {
    $('.countdown[data-date]').each(function () {
      var element = $(this),
        ...
        dateFormat =
          typeof element.attr('data-date-format') !== typeof undefined ? element.attr('data-date-format') : daysText,
        fallback;
...
mr = (function (mr, $, window, document) {
  ...
  mr.dropdowns.repositionDropdownsRtl = function ($) {
    ...
    $('.dropdown__container').each(function () {
      ...
      masterOffset = jQuery('.containerMeasure').offset().left;
      menuItem =
        windowWidth - (container.closest('.dropdown').offset().left + container.closest('.dropdown').outerWidth(true));
      content = null;
      ...
      if (typeof window.google.maps !== 'undefined') {
        ...
        jQuery('.gmaps-active').each(function () {
          var mapElement = this,
            ...
            zoomControlPos =
              typeof mapInstance.attr('data-zoom-controls') !== typeof undefined
                ...
                : false,
            latlong =
              typeof mapInstance.attr('data-latlong') !== typeof undefined ? mapInstance.attr('data-latlong') : false,
          ...
          mapAo.zoomControlOptions =
            zoomControlPos !== false ? { position: google.maps.ControlPosition[zoomControlPos] } : undefined;
          ...
          markerAo.icon =
            typeof mapInstance.attr('data-marker-image') !== typeof undefined
              ? { url: mapInstance.attr('data-marker-image'), scaledSize: new google.maps.Size(50, 50) }
              : undefined;
  ...
  mr.masonry.windowLoad = function () {
    $('.masonry').each(function () {
      ...
      if (masonryParent.is('[data-default-filter]')) {
        ...
        masonryParent
          .find('li[data-masonry-filter="' + masonryParent.attr('data-default-filter').toLowerCase() + '"]')
          .addClass('active');
      }
